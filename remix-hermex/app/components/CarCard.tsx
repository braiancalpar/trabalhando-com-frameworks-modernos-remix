...
export const CarCard = memo(function CarCard({
  ...
  return (
    <article className="bg-neutral-white rounded-lg shadow-elevation-1 overflow-hidden hover:shadow-elevation-2 transition-shadow">
      {/* Image */}
      <div className="bg-neutral-divisor p-6 flex items-center justify-center min-h-50">
        <img
          src={image}
      ...
      <div className="p-6">
        {/* Title */}
        <h3 className="font-heading font-semibold text-heading-xs text-neutral-black mb-1 line-clamp-2 min-h-12">
          {title}
        </h3>
