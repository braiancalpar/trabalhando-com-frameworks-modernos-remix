  ...
  return (
    <section className="relative w-full bg-secondary-pure overflow-hidden">
      ...
      <div className="relative h-75 sm:h-100 lg:h-125">
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-linear-to-r from-secondary-pure/80 via-secondary-pure/40 to-transparent" />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-xl lg:max-w-2xl">
            <h1 className="font-heading text-heading-lg sm:text-heading-xl lg:text-heading-xxl text-neutral-white mb-4">
              Encontre o carro <span className="text-primary-pure">ideal</span>{" "}
